...
## 🌐 Choose Your Language / Choisissez votre langue / 选择您的语言

*Click on a language below to view the user guide.*

---

<details>
<summary><b>🇺🇸 English (American)</b></summary>
...
### ⚡ Free vs PRO Plan
* **Free Version:**
  * Manual context insertion (date, time, weather) by clicking the **🕒 Clock** button.
  * Access to base layout features.
* **PRO Version:**
...
* **Version Gratuite (FREE) :**
  * Insertion manuelle du contexte (date, heure, météo) en cliquant sur le bouton **🕒 Clock**.
  * Accès aux fonctionnalités de base de l'extension.
...
* **Versión Gratuita:**
  * Inserción manual de contexto (fecha, hora, clima) haciendo clic en el botón **🕒 Clock**.
  * Acceso a las funciones de diseño base.
* **Versión PRO:**
...
* **Versione Gratuita:**
  * Inserimento manuale del contesto (data, ora, meteo) cliccando sul pulsante **🕒 Clock**.
...
* **Versão Gratuita:**
  * Inserção manual de contexto (data, hora, clima) clicando no botão **🕒 Clock**.
...
<details>
<summary><b>🇨🇳 中文 (Mandarin Chinese)</b></summary>
...
* **النسخة المجانية:**
  * إدخال السياق (الوقت، التاريخ، الطقس) يدويًا عبر النقر على زر **🕒 Clock**.
  * الوصول إلى ميزات الواجهة الأساسية.
* **نسخة PRO:**
...
* **Бесплатная версия:**
  * Ручная вставка контекста (время, дата, погода) при нажатии на кнопку **🕒 Clock**.
  * Доступ к базовым функциям макета.
* **Версия PRO:**
...
* **무료 버전 (Free):**
  * **🕒 Clock** 버튼을 클릭하여 컨텍스트(날짜, 시간, 날씨)를 입력창에 수동 삽입.
  * 기본적인 레이아웃 기능 제공.
* **프로 버전 (PRO):**
...
* **मुफ्त संस्करण:**
  * **🕒 Clock** बटन पर क्लिक करके मैन्युअल रूप से संदर्भ (तारीख, समय, मौसम) दर्ज करें।
...
* **Ücretsiz Sürüm:**
  * **🕒 Clock** butonuna basarak manuel bağlam ekleme (saat, tarih, hava durumu).
  * Temel arayüz özelliklerine erişim.
* **PRO Sürümü:**
...
### ⚡ Plan Darmowy vs PRO
* **Wersja Darmowa:**
  * Ręczne wklejanie kontekstu (data, czas, pogoda) poprzez kliknięcie przycisku **🕒 Clock**.
  * Dostęp do podstawowych funkcji interfejsu.
* **Wersja PRO:**
...
* **Gratisversion:**
  * Manuell inmatning av kontext (datum, tid, väder) genom att klicka på **🕒 Clock**-knappen.
  * Tillgång till grundläggande layoutfunktioner.
* **PRO-version:**
...
## 📄 File Structure / Structure des fichiers / 文件结构
